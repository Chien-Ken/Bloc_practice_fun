...
import 'package:bloc_practice/Cubit/like_image_view.dart';
import 'package:bloc_practice/Cubit/list_like.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class LikeImagePage extends StatelessWidget {
   LikeImagePage({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(create: (context) => LikeCubit(),
    child: Scaffold(
      appBar: AppBar(
                ...
                return Stack(
                  children: [
                    Image.asset(imageUrl, fit: BoxFit.cover),
                      InkWell(
                        onTap: () {
                          context.read<LikeCubit>().toggleLike(imageUrl);
                        },
                        child: Icon(
